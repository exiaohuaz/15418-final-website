...
def calcSpeedup(image):
    ...
    trials = 3
    cmd1 = f"./raytrace-sequential ../images/{image} ../images/outputConv.png lights.txt ../images/outputSeq.png"
    cmd2 = f"./raytrace-parallel ../images/{image} ../images/outputConv.png lights.txt ../images/outputPar.png"
    seqTotal = 0
    parTotal = 0
